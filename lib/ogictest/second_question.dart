...
import 'third_question.dart';

class SecondQuestion extends StatefulWidget {
  final String nameFromTextField;

  SecondQuestion({Key key, this.nameFromTextField}) : super(key: key);
...
class _SecondQuestionState extends State<SecondQuestion> {
                ...
                ListView(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        'Q2: Drill bit with 20-degree back rake angle is best for ……… formation.',
  ...
  void _updateAnswer(BuildContext context, int position) {
    ...
    testRef.child('$showName').update({'answer2': finalAnswer});
  }
