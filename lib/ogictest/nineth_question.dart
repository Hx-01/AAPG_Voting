...
import 'tenth_question.dart';

class NinethQuestion extends StatefulWidget {
  final String nameFromTextField;

  NinethQuestion({Key key, this.nameFromTextField}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _NinethQuestionState();
  }
}

final testRef = FirebaseDatabase.instance.reference().child("Test");

class _NinethQuestionState extends State<NinethQuestion> {
            ...
            ListView(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(
                      'Q9: The drill off test is used to select the best ……. ',
  ...
  void _updateAnswer(BuildContext context, int position) {
    ...
    testRef.child('$showName').update({'answer9': finalAnswer});
  }
  ...
  void navigateToNextQuestion() {
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return TenthQuestion(nameFromTextField: showName,);
    }));
  }
}
