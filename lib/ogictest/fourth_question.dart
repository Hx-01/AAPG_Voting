...
import 'fiveth_question.dart';

class FourthQuestion extends StatefulWidget {
  final String nameFromTextField;

  FourthQuestion({Key key, this.nameFromTextField}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _FourthQuestionState();
  }
}
...
class _FourthQuestionState extends State<FourthQuestion> {
                ...
                ListView(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        'Q4:Lifting cuttings out of the well-bore when drilling with a dry gas in underbalanced drilling depends on ……… alone.',
  ...
  void _updateAnswer(BuildContext context, int position) {
    ...
    testRef.child('$showName').update({'answer4': finalAnswer});
  }
