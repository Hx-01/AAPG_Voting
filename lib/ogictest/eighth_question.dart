...
import 'nineth_question.dart';

class EighthQuestion extends StatefulWidget {
  final String nameFromTextField;

  EighthQuestion({Key key, this.nameFromTextField}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _EighthQuestionState();
  }
}
...
class _EighthQuestionState extends State<EighthQuestion> {
            ...
            ListView(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(
                      'Q8: The build rate of the medium radius well is ……',
  ...
  void _updateAnswer(BuildContext context, int position) {
    ...
    testRef.child('$showName').update({'answer8': finalAnswer});
  }
  ...
  void navigateToNextQuestion() {
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return NinethQuestion(nameFromTextField: showName,);
    }));
  }
}
