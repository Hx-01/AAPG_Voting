...
import 'submit_test.dart';

class TenthQuestion extends StatefulWidget {
  final String nameFromTextField;

  TenthQuestion({Key key, this.nameFromTextField}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _TenthQuestionState();
  }
}

final testRef = FirebaseDatabase.instance.reference().child("Test");

class _TenthQuestionState extends State<TenthQuestion> {
  List<String> getListElements() {
    List<String> list = List<String>();
    list.add('Royalty Tax Systems');
    list.add('Production Sharing Agreement');
    list.add('Service Contracts');
    return list;
  }
                ...
                ListView(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        'Q10:What is the most common type of Petroleum Agreements nowadays in Egypt?',
  ...
  void _updateAnswer(BuildContext context, int position) {
    ...
    testRef.child('$showName').update({'answer10': finalAnswer});
  }
